...
.infosiga_col_spec <- function(dataset) {
  ...
  spec <- switch(
    ...
    sinistros = readr::cols(
      ...
      mes_sinistro = i(),
      dia_sinistro = i(),
      hora_sinistro = readr::col_time(format = "%H:%M"),
      ano_mes_sinistro = c(),
      dia_da_semana = c(),
      turno = c(),
      logradouro = c(),
      ...
      qtd_caminhao = i(),
      qtd_veic_outros = i(),
      qtd_veic_nao_disponivel = i(),
      qtd_gravidade_fatal = i(),
      qtd_gravidade_grave = i(),
      qtd_gravidade_leve = i(),
      qtd_gravidade_ileso = i(),
      qtd_gravidade_nao_disponivel = i(),
      tp_sinistro_atropelamento = c(),
      tp_sinistro_colisao_frontal = c(),
      tp_sinistro_colisao_traseira = c(),
      tp_sinistro_colisao_lateral = c(),
      tp_sinistro_colisao_transversal = c(),
      tp_sinistro_colisao_outros = c(),
      tp_sinistro_choque = c(),
      tp_sinistro_capotamento = c(),
      tp_sinistro_engavetamento = c(),
      tp_sinistro_tombamento = c(),
      tp_sinistro_outros = c(),
      tp_sinistro_nao_disponivel = c()
    ),
    pessoas = readr::cols(
      id_sinistro = c(),
      id_veiculo = c(),
